...
foreach(_var
	...
	BUILD_DEPENDENCIES_AS_SHARED_LIBS
	ENABLE_QT_UI
	ENABLE_SDL_FRONTEND
	USE_VULKAN
)
...
set(_deps_build_args --build "${_deps_build}")
if(PCSX2_DEPS_JOBS)
	list(APPEND _deps_build_args --parallel ${PCSX2_DEPS_JOBS})
else()
	list(APPEND _deps_build_args --parallel)
endif()

execute_process(
	COMMAND ${CMAKE_COMMAND} ${_deps_build_args}
	RESULT_VARIABLE _deps_result
)
